...
# tdslite devenv image build script
#
# @file   CMakeLists.txt
...
docker build -t $PROJECT_METADATA_DOCKER_REPOSITORY_URL/$PROJECT_METADATA_DOCKER_DEVENV_IMAGE_NAME:$PROJECT_METADATA_VERSION -f $SCRIPT_ROOT/Dockerfile $PROJECT_ROOT
